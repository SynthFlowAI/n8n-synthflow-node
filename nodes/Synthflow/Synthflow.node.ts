  ...
  description: INodeTypeDescription = {
    ...
    properties: [
        ...
        options: [
          {
            ...
            value: "createAgent",
            description:
              "Create a new Synthflow voice agent (outbound, inbound, or widget)",
          ...
          },
          {
            name: "Get Call",
            value: "getCall",
            description: "Retrieve transcript and metadata for a specific call",
            action: "Get a call",
          },
          {
            name: "List Agents",
          ...
          },
          {
            ...
            value: "listCalls",
            description:
              "List calls for a specific agent with optional filters",
            action: "List calls",
          },
          {
            name: "Make a Call",
            value: "makeCall",
            description:
              "Initiate an outbound phone call using a Synthflow AI agent",
            action: "Make a call",
          },
          {
            name: "Update Agent",
        ...
        options: [
          {
            ...
            default: {},
            description:
              "Key-value pairs to dynamically inject into the prompt",
            options: [
              {
                name: "variables",
          ...
          },
          {
            ...
            description:
              "Custom greeting the agent will use when the call is answered",
          },
          {
          ...
          },
          {
            ...
            default: "",
            description:
              "Custom prompt for the AI agent to use during the call",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        required: true,
        description:
          "Greeting message the agent will use at the start of the conversation",
        displayOptions: {
          show: {
            operation: ["createAgent"],
          },
      ...
      },
      {
        ...
        required: true,
        description:
          "Language model identifier (for example, gpt-5.1 or gpt-5)",
        displayOptions: {
          show: {
            operation: ["createAgent"],
          },
      ...
      },
      {
        ...
        options: [
          ...
          },
          {
            ...
            default: false,
            description:
              "Whether call recording should be enabled for this agent",
          },
          {
            ...
            default: 0,
            description:
              "Maximum call length in seconds before the agent automatically ends the call",
          },
          {
          ...
          },
          {
            ...
            description:
              "Phone number attached to the agent for inbound or outbound calls",
          },
        ],
      },
      {
        ...
        default: "",
        required: true,
        placeholder: "1691579123700x31589864853004400",
      ...
      {
        displayName: "Model ID",
        name: "listCallsModelId",
        type: "string",
        default: "",
        required: true,
        placeholder: "agent_123abc",
        description: "The ID of the agent to list calls for",
        displayOptions: {
          show: {
            operation: ["listCalls"],
          },
      ...
      },
      {
        ...
        default: 20,
        description: "How many calls will be displayed in every page",
        displayOptions: {
          show: {
            operation: ["listCalls"],
          },
        ...
        options: [
          {
            ...
            type: "string",
            default: "",
            description: "Status of call (e.g., completed, failed, busy)",
          },
          {
            displayName: "Duration Max (Seconds)",
            name: "duration_max",
            type: "number",
            default: 0,
            description:
          ...
          {
            displayName: "Duration Min (Seconds)",
            name: "duration_min",
            type: "number",
            default: 0,
            description:
              "Only retrieve calls with duration greater than or equal to this value",
          },
          {
          ...
          },
          {
            ...
            type: "string",
            default: "",
            placeholder: "%2B14155552671",
            description:
              'Phone number of the caller or callee (E.164 format, URL-encode the leading "+")',
          },
          {
            displayName: "To Date",
            name: "to_date",
            type: "number",
            default: 0,
            description: "End timestamp (milliseconds since epoch) of the call",
          },
        ],
      },
      {
    ...
    for (let i = 0; i < items.length; i++) {
      try {
        if (operation === "makeCall") {
          ...
          const greetingMessage = this.getNodeParameter(
          ...
          const additionalAgentFields = this.getNodeParameter(
            "additionalAgentFields",
            i,
            {}
          ) as any;
          ...
          if (additionalAgentFields.agentJson) {
            ...
            try {
              parsedAgent = JSON.parse(
                additionalAgentFields.agentJson as string
              );
            } catch (error) {
              throw new NodeOperationError(
                this.getNode(),
                "Invalid JSON in Agent JSON field",
                {
                  itemIndex: i,
                }
              );
          ...
          if (additionalAgentFields.external_webhook_url) {
            body.external_webhook_url =
              additionalAgentFields.external_webhook_url;
          }

          if (additionalAgentFields.inbound_call_webhook_url) {
            body.inbound_call_webhook_url =
              additionalAgentFields.inbound_call_webhook_url;
          }
          ...
          if (
            typeof additionalAgentFields.max_duration_duration_seconds ===
              "number" &&
            additionalAgentFields.max_duration_duration_seconds > 0
          ) {
            body.max_duration = body.max_duration || {};
            body.max_duration.duration_seconds =
              additionalAgentFields.max_duration_duration_seconds;
          }

          if (
            typeof additionalAgentFields.max_duration_is_enabled === "boolean"
          ) {
            body.max_duration = body.max_duration || {};
            body.max_duration.is_enabled =
              additionalAgentFields.max_duration_is_enabled;
          }
          ...
          if (typeof additionalAgentFields.is_consent_enabled === "boolean") {
            body.agent.is_consent_enabled =
              additionalAgentFields.is_consent_enabled;
          }
          ...
          const agentModelId = this.getNodeParameter(
            "agentModelId",
            i
          ) as string;
          ...
          if (updateFields.inbound_call_webhook_url) {
            body.inbound_call_webhook_url =
              updateFields.inbound_call_webhook_url;
          }
          ...
          if (
            ...
            body.max_duration = body.max_duration || {};
            body.max_duration.duration_seconds =
              updateFields.max_duration_duration_seconds;
          }
          ...
          const responseData =
            await this.helpers.httpRequestWithAuthentication.call(
              ...
              {
                method: "GET",
                url: `https://api.synthflow.ai/v2/calls/${callId}`,
                json: true,
              }
            );
          ...
          returnData.push(...executionData);
        } else if (operation === "listCalls") {
          const modelId = this.getNodeParameter(
            "listCallsModelId",
            i
          ) as string;
          const limit = this.getNodeParameter("listCallsLimit", i) as number;
          const offset = this.getNodeParameter("listCallsOffset", i) as number;
          ...
          if (filters.from_date && filters.from_date > 0) {
            qs.from_date = filters.from_date;
          }

          if (filters.to_date && filters.to_date > 0) {
            qs.to_date = filters.to_date;
          }
          ...
          if (filters.duration_min && filters.duration_min > 0) {
            qs.duration_min = filters.duration_min;
          }

          if (filters.duration_max && filters.duration_max > 0) {
            qs.duration_max = filters.duration_max;
          }

          if (filters.lead_phone_number) {
            qs.lead_phone_number = filters.lead_phone_number;
          }
